...
namespace MyLibrary.Controllers
{
    public class LibrariesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Genre,FirstShelf")] Library library)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Genre,FirstShelf")] Library library)
        {
            if (id != library.Id)
            {
                return NotFound();
